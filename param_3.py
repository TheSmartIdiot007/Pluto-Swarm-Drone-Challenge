...
class Params:
    def __init__(self):
        ...
        self.parser.add_argument('--ip', type=str, default='192.168.64.143')
        self.parser.add_argument('--task', type=int, default=3)
        self.parser.add_argument('--camera_port', type=int, default=9060)
        self.parser.add_argument('--name', type=str, default='Drone3')
        
        self.parser.add_argument('--zero_pitch_value', type= int, default=1500)
        self.parser.add_argument('--zero_roll_value', type= int, default=1485)
        ...
        self.parser.add_argument('--yaw_ff', type=int, default=1491)
