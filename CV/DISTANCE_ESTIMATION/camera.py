...
class Cam_feed:
    ...
    def __init__(self, args):
        ...
        # self.vid.set(cv2.CAP_PROP_FPS, args.camera_fps)
        # set the video codec
        codec = cv2.VideoWriter_fourcc(*'MJPG')
        self.vid.set(cv2.CAP_PROP_FOURCC, codec)
        self.vid.set(cv2.CAP_PROP_FPS, 400)
    ...
    def grab_frame(self):
        ...
        try:
            ...
            if ret:
                ...
                # print('ARUCO processing fps', 1/(time() - t0))
...
if __name__ == '__main__':
    ...
    while True:
        ...
        cam.grab_frame()
        # print (1/(t0-time()))
        # cv2.imshow('frame', cam.rgb_img_out) 
        
               # print(cam.frame_grabTime)
        # print (cam)       
