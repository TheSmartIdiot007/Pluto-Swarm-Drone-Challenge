        ...
        while True:
            if self.controller.log:
                ...
                if self.controller.error_ready:
                    ...
                    self.writer.add_scalar('Controller/X_error', self.controller.pos_error[0], global_step=self.step)
                    self.writer.add_scalar('Controller/Y_error', self.controller.pos_error[1], global_step=self.step)
                    self.writer.add_scalar('Controller/Z_error', self.controller.pos_error[2], global_step=self.step)
                ...
                # CV Data
                self.writer.add_scalar('CV/X', self.controller.vision.X[self.args.id_main][0][0], global_step=self.step)
                self.writer.add_scalar('CV/Y', self.controller.vision.Y[self.args.id_main][0][0], global_step=self.step)
                self.writer.add_scalar('CV/Z', self.controller.vision.Z[self.args.id_main][0][0], global_step=self.step)

                self.writer.add_scalar('CV/Vx', self.controller.vision.X[self.args.id_main][1][0], global_step=self.step)
                self.writer.add_scalar('CV/Vy', self.controller.vision.Y[self.args.id_main][1][0], global_step=self.step)
                self.writer.add_scalar('CV/Vz', self.controller.vision.Z[self.args.id_main][1][0], global_step=self.step)
