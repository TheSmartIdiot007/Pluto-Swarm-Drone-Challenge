...
class SliderInput(tk.Tk):
    def __init__(self, name = 'None', controller = None):
        ...
        self.slider1.bind("<ButtonRelease-1>", self.update)         #bind to update function
        ...
        self.slider2.bind("<ButtonRelease-1>", self.update)         #bind to update function
        ...
        self.slider3.bind("<ButtonRelease-1>", self.update)         #bind to update function

        print("slider init done "+ name)

    #update function to update the value from slider
